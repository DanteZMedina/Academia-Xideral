...
public class SalesAnalyzer {
    ...
    public static void main(String[] args) {
        ...
        // 4️⃣ Ingresos por región (mayor a menor)
        System.out.println("\n=== Ingresos por Region ===");
        ...
        // 6️⃣ Producto más caro por región
